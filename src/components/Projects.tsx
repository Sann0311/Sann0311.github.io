...
const projects = [
    ...
    },
    {
        ...
        details: "Built a Python-based phishing detection system to flag AI-generated spoofing patterns, malicious URL behavior, and brand impersonation. Achieved 95% detection accuracy on 10,000+ emails and reduced manual triage effort by 65%.",
